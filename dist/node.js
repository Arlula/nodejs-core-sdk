...
"use strict";
module.exports = JSON.parse("{\"_from\":\"axios@^0.21.1\",\"_id\":\"axios@0.21.1\",\"_inBundle\":false,\"_integrity\":\"sha512-dKQiRHxGD9PPRIUNIWvZhPTPpl1rf/OxTYKsqKUDjBwYylTvV7SjSHJb9ratfyzM6wCdLCOYLzs73qpg5c4iGA==\",\"_location\":\"/axios\",\"_phantomChildren\":{},\"_requested\":{\"type\":\"range\",\"registry\":true,\"raw\":\"axios@^0.21.1\",\"name\":\"axios\",\"escapedName\":\"axios\",\"rawSpec\":\"^0.21.1\",\"saveSpec\":null,\"fetchSpec\":\"^0.21.1\"},\"_requiredBy\":[\"/\"],\"_resolved\":\"https://registry.npmjs.org/axios/-/axios-0.21.1.tgz\",\"_shasum\":\"22563481962f4d6bde9a76d516ef0e5d3c09b2b8\",\"_spec\":\"axios@^0.21.1\",\"_where\":\"D:\\\\Go Projects\\\\src\\\\github.com\\\\Arlula\\\\jsSDK\",\"author\":{\"name\":\"Matt Zabriskie\"},\"browser\":{\"./lib/adapters/http.js\":\"./lib/adapters/xhr.js\"},\"bugs\":{\"url\":\"https://github.com/axios/axios/issues\"},\"bundleDependencies\":false,\"bundlesize\":[{\"path\":\"./dist/axios.min.js\",\"threshold\":\"5kB\"}],\"dependencies\":{\"follow-redirects\":\"^1.10.0\"},\"deprecated\":false,\"description\":\"Promise based HTTP client for the browser and node.js\",\"devDependencies\":{\"bundlesize\":\"^0.17.0\",\"coveralls\":\"^3.0.0\",\"es6-promise\":\"^4.2.4\",\"grunt\":\"^1.0.2\",\"grunt-banner\":\"^0.6.0\",\"grunt-cli\":\"^1.2.0\",\"grunt-contrib-clean\":\"^1.1.0\",\"grunt-contrib-watch\":\"^1.0.0\",\"grunt-eslint\":\"^20.1.0\",\"grunt-karma\":\"^2.0.0\",\"grunt-mocha-test\":\"^0.13.3\",\"grunt-ts\":\"^6.0.0-beta.19\",\"grunt-webpack\":\"^1.0.18\",\"istanbul-instrumenter-loader\":\"^1.0.0\",\"jasmine-core\":\"^2.4.1\",\"karma\":\"^1.3.0\",\"karma-chrome-launcher\":\"^2.2.0\",\"karma-coverage\":\"^1.1.1\",\"karma-firefox-launcher\":\"^1.1.0\",\"karma-jasmine\":\"^1.1.1\",\"karma-jasmine-ajax\":\"^0.1.13\",\"karma-opera-launcher\":\"^1.0.0\",\"karma-safari-launcher\":\"^1.0.0\",\"karma-sauce-launcher\":\"^1.2.0\",\"karma-sinon\":\"^1.0.5\",\"karma-sourcemap-loader\":\"^0.3.7\",\"karma-webpack\":\"^1.7.0\",\"load-grunt-tasks\":\"^3.5.2\",\"minimist\":\"^1.2.0\",\"mocha\":\"^5.2.0\",\"sinon\":\"^4.5.0\",\"typescript\":\"^2.8.1\",\"url-search-params\":\"^0.10.0\",\"webpack\":\"^1.13.1\",\"webpack-dev-server\":\"^1.14.1\"},\"homepage\":\"https://github.com/axios/axios\",\"jsdelivr\":\"dist/axios.min.js\",\"keywords\":[\"xhr\",\"http\",\"ajax\",\"promise\",\"node\"],\"license\":\"MIT\",\"main\":\"index.js\",\"name\":\"axios\",\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/axios/axios.git\"},\"scripts\":{\"build\":\"NODE_ENV=production grunt build\",\"coveralls\":\"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js\",\"examples\":\"node ./examples/server.js\",\"fix\":\"eslint --fix lib/**/*.js\",\"postversion\":\"git push && git push --tags\",\"preversion\":\"npm test\",\"start\":\"node ./sandbox/server.js\",\"test\":\"grunt test && bundlesize\",\"version\":\"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json\"},\"typings\":\"./index.d.ts\",\"unpkg\":\"dist/axios.min.js\",\"version\":\"0.21.1\"}");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var index_1 = __importDefault(__webpack_require__(/*! ./archive/index */ "./src/archive/index.ts"));
    ...
    Orders.prototype.list = function () {
        ...
        return this._client.get(listURL)
            ...
            for (var i = 0; i < resp.data.length; i++) {
                var ord = order_1.fromJSON(_this._client, resp.data[i]);
                if (!(ord instanceof order_1.default)) {
                    return Promise.reject(ord);
                }
                orders.push(ord);
...
function fromJSON(client, json) {
    ...
    if (json.resources && Array.isArray(json.resources)) {
        for (var i = 0; i < json.resources.length; i++) {
            var res = resource_1.fromJSON(client, json.resources[i]);
            if (res instanceof resource_1.default) {
                resources.push(res);
                continue;
            }
            return res;
...
var Order = /** @class */ (function () {
    ...
    Object.defineProperty(Order.prototype, "supplier", {
        get: function () {
    ...
    Object.defineProperty(Order.prototype, "imageryID", {
        get: function () {
    ...
    Object.defineProperty(Order.prototype, "sceneID", {
        get: function () {
    ...
    Object.defineProperty(Order.prototype, "expiration", {
        get: function () {
            if (this._expiration) {
    ...
    Object.defineProperty(Order.prototype, "resources", {
        get: function () {
    ...
    Order.prototype.loadResources = function () {
        ...
        return this._client.get(getURL, { params: { id: this._id } })
            ...
            for (var i = 0; i < resp.data.resources.length; i++) {
                var res = resource_1.fromJSON(_this._client, resp.data.resources[i]);
                if (!(res instanceof resource_1.default)) {
...
var Resource = /** @class */ (function () {
    ...
    Object.defineProperty(Resource.prototype, "order", {
        get: function () {
            return this._order;
        },
        enumerable: false,
...
(function (ResourceType) {
    ...
    ResourceType["ImageryJP2"] = "img_jp2";
    ResourceType["Thumb"] = "thumb";
    ResourceType["Overview"] = "gdal_tiff_overview";
    ResourceType["MetadataMTL"] = "meta_mtl";
    ResourceType["MetadataJSON"] = "meta_json";
    ResourceType["MetadataXML"] = "meta_xml";
    ResourceType["MetadataBundle"] = "meta_bundle";
    ResourceType["GeometryJSON"] = "geo_json";
    ResourceType["GeometryKml"] = "geo_kml";
    ResourceType["GeometryShapefile"] = "geo_shp";
    ResourceType["GeometryBundle"] = "geo_bundle";
